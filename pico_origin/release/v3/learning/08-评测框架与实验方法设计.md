...
![2993f1d212a410873ddcb1a65e47fdb8.svg](./img/WoVEYKeurwgXGsmk/2993f1d212a410873ddcb1a65e47fdb8-241525.svg)

这张图最重要的地方是，`Pico` 不是只算一个 pass rate。它前面有任务合同，中间有执行器，后面还有工件聚合和实验层。这样最后的数字才有上下文。

## benchmark 任务先被定义成合同

固定任务定义在 [benchmarks/coding\_tasks.json](/Users/martinlos/code/pico/benchmarks/coding_tasks.json)。
...
* `aggregate_run_artifacts()` 会聚 attempts、tool\_steps、cache、时长、工具状态、安全事件
...
> 原文: <https://www.yuque.com/u63312805/df29bk/qmhvn3kkaggunewe>