                    ...
                    if agent.model_request_budget.request_over_budget(selector_prompt):
                        ...
                        agent.emit_trace(
                            ...
                            "map_selector_requested",
                            {
                                ...
                                "definition_count": selector_catalog.definition_count,
                                "rendered_definition_count": selector_catalog.rendered_definition_count,
                                "catalog_truncated": selector_catalog.truncated,
